...
public class WebUserController {
    ...
    public Map getUserInfobyid(
        ...
        data.put("academic", user.getAcademic() != null ? user.getAcademic().toString() : null);
        data.put("monthly", user.getMonthly() != null ? user.getMonthly().toString() : null);
        data.put("permanent", user.getPermanent() != null ? user.getPermanent().toString() : null);
        return data;
    }
