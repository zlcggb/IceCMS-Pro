...
-- ----------------------------
BEGIN;
INSERT INTO `home_setting` (`id`, `feature_title`, `feature_src`) VALUES (1, 'sad', 'asd12');
INSERT INTO `home_setting` (`id`, `feature_title`, `feature_src`) VALUES (2, 'asd', 'asd2');
INSERT INTO `home_setting` (`id`, `feature_title`, `feature_src`) VALUES (3, 'asd', 'asd2');
INSERT INTO `home_setting` (`id`, `feature_title`, `feature_src`) VALUES (4, 'asd', 'asd3');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `s_mini_info` (`id`, `appid`, `secret`, `env_version`) VALUES (1, 'wxc6431f81c7cbaea1', '8f3d2707f59c9c44aa2cf7ccba641571', 'release');
COMMIT;
...
CREATE TABLE `setting` (
                           ...
                           `sit_src` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `setting` (`id`, `sit_title`, `sit_src`, `beian`, `banquan`, `sit_logo`, `image_format`, `comment_show`) VALUES (1, 'IceCMS', 'www.icecms.cn', '鲁ICP备1390123123号', 'www.icecms.cn © 2024. All rights reserved.', 'http://192.168.0.123:8181/logistics/24cbedcd-f13d-466e-9444-3f35ec27c67c.png', '0', 0);
COMMIT;
...
INSERT INTO `user` (`user_id`, `openid`, `userage`, `intro`, `gender`, `name`, `USERNAME`, `PASSWORD`, `email`, `phone`, `code`, `data`, `role`, `profile`, `status`, `create_time`, `last_login`, `vip_valid_date`, `vip_expire_date`, `integral`, `vip_disable_tip`, `height`, `issingle`, `birthday`, `academic`, `monthly`, `permanent`) VALUES (3, NULL, 17, '这个人很懒，什么都没有留下！', 0, '悠悠', 'admin', '$argon2i$v=19$m=65536,t=3,p=1$XJawZ6v9/f3cL+AjrFvbJQ$F9rPIPu4tAryKYWI/X8kTxb5tS17wZkndpMi+OT5Jrg', '123@qq.com', '172382732', NULL, NULL, NULL, 'https://img2.woyaogexing.com/2022/07/17/5bbaa5352282a8f7!400x400.jpg', '1', '2022-08-20 08:46:46', '2024-07-24 13:27:43', '2022-06-06 08:58:28', '2022-07-06 08:58:28', 233, 1, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `user` (`user_id`, `openid`, `userage`, `intro`, `gender`, `name`, `USERNAME`, `PASSWORD`, `email`, `phone`, `code`, `data`, `role`, `profile`, `status`, `create_time`, `last_login`, `vip_valid_date`, `vip_expire_date`, `integral`, `vip_disable_tip`, `height`, `issingle`, `birthday`, `academic`, `monthly`, `permanent`) VALUES (74, NULL, NULL, '这个人很懒，什么都没有留下！', NULL, '新用户', '00043197', '$argon2i$v=19$m=65536,t=3,p=1$m4qEjFlBa6GBC0csWJFUsw$f5YqUEOv8ubLcXg76IIruFi8imWzoj7mD4+ThfUqCh0', '23339097@qq.com', NULL, NULL, NULL, NULL, 'https://img2.woyaogexing.com/2022/07/17/5bbaa5352282a8f7!400x400.jpg', NULL, '2024-07-20 14:52:21', '2024-07-20 14:55:10', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` (`user_id`, `openid`, `userage`, `intro`, `gender`, `name`, `USERNAME`, `PASSWORD`, `email`, `phone`, `code`, `data`, `role`, `profile`, `status`, `create_time`, `last_login`, `vip_valid_date`, `vip_expire_date`, `integral`, `vip_disable_tip`, `height`, `issingle`, `birthday`, `academic`, `monthly`, `permanent`) VALUES (75, NULL, 0, '这个人很懒，什么都没有留下！', NULL, '手机用户', '1bc82b3d2e4042668e0a4fdb101e17c3', NULL, '0', '17630505717', NULL, NULL, '0', NULL, '0', '2024-07-24 13:11:37', '2024-07-24 13:11:37', '2024-07-24 13:11:37', '2024-07-24 13:11:37', 0, 1, '0', NULL, '0', '0', '0', '0');
COMMIT;
