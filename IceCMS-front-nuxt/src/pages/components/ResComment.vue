<template>
  <transition name="slide-fade">
    ...
    <div v-if="close" class="
        chat-container
        overflow-hidden
        van-popup van-popup--round van-popup--bottom
      ">
      <div v-show="userJudje" role="dialog" aria-labelledby="输入昵称和邮箱" class="van-dialog shadow-4 position-absolute"
        style="width: 360px; z-index: 2011">
        <div class="van-dialog__header">输入昵称和邮箱</div>
        <div class="van-dialog__content">
          <div class="px-6 py-5">
            <p>
              <span class="text-success">推荐使用 QQ 邮箱</span>，有紧急的问题可以快速联系到您。
            </p>
            <div class="form-group comment-form-group">
              <input v-model="tempuserform.username" type="text" placeholder="您的昵称" class="form-control rounded" />
            </div>
            <div class="form-group comment-form-group">
              <input v-model="tempuserform.email" type="email" placeholder="您的邮箱" class="form-control rounded" />
            </div>
          </div>
        </div>
        <div class="van-hairline--top van-dialog__footer">
          <button @click="cansoles()" class="
          ...
          </button><button @click="savetempsuser()" class="
              van-button van-button--default van-button--large
              van-dialog__confirm
              van-hairline--left
            ">
      ...
      <div class="h-full w-full">
        <div id="chatRecord" class="chat-body p-4">
          <div class="in finite-loading-container">
            ...
            <div class="infinite-status-prompt" style="display: none">
              <div class="mt-10">
                <img src="static/picture/comments.svg" class="w-80 mb-4" />
          ...
          <div v-for="(item, id) in this.comment" :key="id" class="d-flex mb-3">
                      ...
                      <g id="Avataaar" stroke-width="1" fill-rule="evenodd" fill="black" mask="url(#mask-2)">
                        <g id="Body" transform="translate(32.000000, 36.000000)">
                          ...
                          <path
                            ...
                            id="Neck-Shadow" fill-opacity="0.100000001" fill="#000000" mask="url(#mask-silhouette)">
                          </path>
                        </g>
                        <svg>
                          ...
                          <g id="Top" strokewidth="1" fillrule="evenodd">
                            <defs>
                              ...
                              <path
                                ...
                                id="ShortHairShortWaved-path1"></path>
                            ...
                            <g id="Top/Short-Hair/Short-Waved" mask='url("#ShortHairShortWaved-mask2")'>
                              <g transform="translate(-1.000000, 0.000000)">
                                ...
                                <use class="CustomColor" stroke="none" fill="var(--avataaar-hair-color)"
                                  fillrule="evenodd" href="#ShortHairShortWaved-path1"></use>
                              </g>
                            </g>
                          </g>
                        </svg>
                          ...
                          <g id="Facial-Hair/Moustache-Fancy" transform="translate(49.000000, 72.000000)">
                            <defs>
                              <path
                                ...
                                id="MoustacheFancy-path1"></path>
                            </defs>
                            <mask id="MoustacheFancy-mask1" fill="white">
                              <use href="#MoustacheFancy-path1"></use>
                            </mask>
                            <use class="CustomColor" fill="var(--avataaar-facial-hair-color)" fillrule="evenodd"
                              href="#MoustacheFancy-path1"></use>
                          </g>
                        </svg>
                        <svg>
            ...
            <section class="flex-grow">
              <div class="mb-1">
                ...
                <span class="opacity-70 fs-12 text-muted pl-1"><span>{{ formatDate(item.addTime) }}</span></span>
              </div>
              <!---->
        ...
        <div class="chat-footer">
          ...
          <div class="d-flex align-items-center pl-3 clearfix">
            <a @click="openemig()" class="nav-link p-0 cursor-pointer"><i class="icon-smile fs-18" /></a>
            <span>
              <div id="el-popover-4635" role="tooltip" aria-hidden="true" class="el-popover el-popper emoji-popover"
                style="width: undefinedpx; display: none">
                <!---->

                <div class="macwk-emoji">
                  <div class="d-flex nav">
                    <a class="nav-link flex-grow-1 cursor-pointer active"><span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" width="24" height="24">
                          <path d="M13 4h-2l-.001 7H9v2h2v2h2v-2h4v-2h-4z" />
                          <path
                            d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0m0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10" />
                        </svg></span></a>
                    <a class="nav-link flex-grow-1 cursor-pointer"><span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 24 24" width="24" height="24">
                          <path
                            d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0m0 22C6.486 22 2 17.514 2 12S6.486 2 12 2s10 4.486 10 10-4.486 10-10 10" />
                          <path
            ...
            <div class="comment-post flex-grow text-right">
              <span><button @click="setmap()" class="btn btn-theme btn-sm px-5 pt-1 fs-14"
