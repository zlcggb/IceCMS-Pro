...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo>
  ...
  @Override
  public OrderInfo createOrderLoginByAliResourceId(
      Long ResourceId, String payMent, Integer userid) {
  ...
  @Override
  public OrderInfo createOrdervipIntegralLoginByPrice(
      Integer price, String payMent, Integer userid) {
  ...
  @Override
  public OrderInfo createOrdervipLoginByPrice(
      Integer price, String payMent, Integer userid, Integer payid) {

    // 查找已存在但未支付的订单
    OrderInfo orderInfo =
        this.getNoPayOrderByProductIdAndFee(Long.valueOf(payid), price, userid, "支付宝");
  ...
  @Override
  public OrderInfo createOrderForVipIntegralLoginByPrice(
      Integer price, String payMent, Integer userid) {
  ...
  @Override
  public OrderInfo createOrderForVipLoginByPrice(
      Integer price, String payMent, Integer userid, Integer payid) {

    // 查找已存在但未支付的订单
    OrderInfo orderInfo =
        this.getNoPayOrderByProductIdAndFee(Long.valueOf(payid), price, userid, "微信");
    if (orderInfo != null && orderInfo.getUserId() != null) {
      return orderInfo;
    }
   ...
   * @return
   */
  private OrderInfo getNoPayOrderByProductIdAndFee(
      Long productId, Integer fee, Integer Userid, String payMent) {
   ...
   * @return
   */
  private OrderInfo getNoPayOrderByProductIdAndUser(
      Long productId, Integer Userid, String payMent) {
