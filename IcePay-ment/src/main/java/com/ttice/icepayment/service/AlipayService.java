...
//  Map<String, Object> ftofPay(Long productId) throws Exception;
  ...
  Map<String, Object> ftofvipLoginPay(Integer price, Integer userid, Integer payid)
      throws Exception;
   ...
   */
  Boolean alipayCheckSign(HttpServletRequest request, AlipayClientEntity alipayClientEntity)
      throws AlipayApiException;
   ...
   */
  Map<String, Object> getAlipayTradeStatus(AlipayClientEntity alipayClientEntity, String orderId)
      throws AlipayApiException;
