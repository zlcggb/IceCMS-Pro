...
public class AlipayServiceImpl implements AlipayService {
  ...
  public Map<String, Object> ftofLoginPay(Long ResourceId, Integer userid) throws Exception {
    ...
    // 生成订单
    OrderInfo orderInfo =
        orderInfoService.createOrderLoginByAliResourceId(ResourceId, "支付宝", userid);
    String codeUrl = orderInfo.getCodeUrl();
  ...
  public Map<String, Object> ftofvipIntegralLoginPay(Integer price, Integer userid)
      throws Exception {
  ...
  public Map<String, Object> ftofvipLoginPay(Integer price, Integer userid, Integer payid)
      throws Exception {
...
//            .createOrderByAliProductId(productId, "支付宝");
//    String codeUrl = orderInfo.getCodeUrl();
//
//    if (orderInfo != null && !org.springframework.util.StringUtils.isEmpty(codeUrl)) {
//      log.info("订单已存在，二维码已保存");
...
//  }
  ...
  public String buildAlipayUrl(
      AlipayClientEntity alipayClientEntity, AlipayTradeInfoEntity alipayTradeInfoEntity)
    ...
    alipayRequest.setNotifyUrl(
        alipayConfig.getNOTIFY_URL().concat(AliNotifyType.FTOF_PAY.getType()));
    // 调用接口
  ...
  @Override
  public Boolean alipayCheckSign(HttpServletRequest request, AlipayClientEntity alipayClientEntity)
      throws AlipayApiException {
    ...
    return AlipaySignature.rsaCheckV1(
        params,
        alipayClientEntity.getAlipayPublicKey(),
        alipayClientEntity.getCharset(),
        alipayClientEntity.getSignType());
  }
  ...
  @Override
  public Map<String, Object> getAlipayTradeStatus(
      AlipayClientEntity alipayClientEntity, String orderId) throws AlipayApiException {
    ...
    if (AlipayConfig.RETURN_CODE_SUCCESS.equals(code)
        && AlipayConfig.RETURN_MSG_SUCCESS.equals(msg)) {
  ...
  private AlipayClient buildAlipayClient(AlipayClientEntity alipayClientEntity) {
    ...
    return new DefaultAlipayClient(
        alipayConfig.getALI_URL(),
        alipayClientEntity.getAppId(),
        alipayClientEntity.getPrivateKey(),
        alipayClientEntity.getContentType(),
        alipayClientEntity.getCharset(),
        alipayClientEntity.getAlipayPublicKey(),
        alipayClientEntity.getSignType());
  }
  ...
  @Override
  public void processOrder(String orderNo, HttpServletRequest request)
  ...
  /**
   * 根据订单号查询微信支付查单接口，核实订单状态 如果订单已支付，则更新商户端订单状态，并记录支付日志 如果订单未支付，则调用关单接口关闭订单，并更新商户端订单状态
   *
   * @param orderNo
   */
  @Transactional(rollbackFor = Exception.class)
  ...
  public String queryOrder(String orderNo) throws Exception {
    ...
    try {
      ...
      AlipayTradeQueryResponse alipayTradeQueryResponse =
          alipayClient.execute(alipayTradeQueryRequest);
