...
public class WxPayServiceImpl implements WxPayService {
  ...
  @Resource private RefundInfoService refundsInfoService;

  @Resource private CloseableHttpClient wxPayNoSignClient; // 无需应答签名
  ...
  public Map<String, Object> nativePay(Long productId) throws Exception {
    ...
    // 调用统一下单API
    HttpPost httpPost =
        new HttpPost(wxPayConfig.getDomain().concat(WxApiType.NATIVE_PAY.getType()));
  ...
  @Transactional(rollbackFor = Exception.class)
  @Override
  public Map<String, Object> nativePayForVipIntegralLogin(Integer price, Integer userid)
      throws Exception {
    ...
    // 生成订单
    OrderInfo orderInfo =
        orderInfoService.createOrderForVipIntegralLoginByPrice(price, "微信", userid);
  ...
  @Transactional(rollbackFor = Exception.class)
  @Override
  public Map<String, Object> nativePayForVipLogin(Integer price, Integer userid, Integer payid)
      throws Exception {
    ...
    // 生成订单
    OrderInfo orderInfo =
        orderInfoService.createOrderForVipLoginByPrice(price, "微信", userid, payid);
  ...
  public Map<String, Object> nativePayV2(Long productId, String remoteAddr) throws Exception {
    ...
    HttpClientUtils client =
        new HttpClientUtils(wxPayConfig.getDomain().concat(WxApiType.NATIVE_PAY_V2.getType()));
    ...
    params.put(
        "notify_url",
        wxPayConfig.getNotifyDomain().concat(WxNotifyType.NATIVE_NOTIFY_V2.getType()));
