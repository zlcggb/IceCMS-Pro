...
public class AlipayForQrcodeController {
  ...
  public R buildAlipayQrcodeUrlLogin(@PathVariable Long resourceId, @PathVariable Integer userid)
      throws Exception {
  ...
  public R buildAlipayQrcodeUrlvipIntegralLogin(
      @PathVariable Integer price, @PathVariable Integer userid) throws Exception {
