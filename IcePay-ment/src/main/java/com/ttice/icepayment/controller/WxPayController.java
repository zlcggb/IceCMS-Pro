...
public class WxPayController {
  ...
  public R nativePayLogin(@PathVariable Long productId, @PathVariable Integer userid)
      throws Exception {
  ...
  public R nativePayVipLogin(
      @PathVariable Integer price, @PathVariable Integer userid, @PathVariable Integer payid)
      throws Exception {
  ...
  public R nativePayVipIntegralLogin(@PathVariable Integer price, @PathVariable Integer userid)
      throws Exception {
